...
Additionally, once your program reaches the _try_ block, the _finally_ block will execute before returning, even if your method's _return_ statement is inside the _try_ block or the _catch_ block.
